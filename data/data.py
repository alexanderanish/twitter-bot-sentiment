import numpy as np
import pandas as pd
from data.crypto_list_gen import getCryptoList

'''includes US stock symbols with market cap > 100 Million, and price above $1. 
